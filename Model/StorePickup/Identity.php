...
class Identity implements IdentityInterface
{
     ...
     * @var string
     */
    private $cacheTag = StorePickup::CACHE_TAG;
    ...
    public function getIdentities(array $resolvedData): array
    {
        ...
        foreach ($items as $item) {
            if (is_array($item) && !empty($item[StorePickupInterface::STORE_PICKUP_ID])) {
                $ids[] = sprintf('%s_%s', $this->cacheTag, $item[StorePickupInterface::STORE_PICKUP_ID]);
                $ids[] = sprintf('%s_%s', $this->cacheTag, $item[StorePickupInterface::IDENTIFIER]);
            }
        }
